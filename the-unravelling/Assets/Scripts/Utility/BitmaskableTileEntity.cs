...
[Serializable]
[CreateAssetMenu(fileName = "BitmaskableTileEntity", menuName = "Entity/BitmaskableTileEntity")]
public class BitmaskableTileEntity : TileEntity {
	...
	public bool BitmaskPredicate(int y, int x, int id) {
		if (this.id == Constants.DIRT) {
			return IsWorldPosTile(y, x, id) || IsWorldPosTile(y, x, Constants.DIRT);
		}
